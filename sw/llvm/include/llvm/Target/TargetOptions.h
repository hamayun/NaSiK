...
namespace llvm {
  ...
  /// CheckCFG - This flag is enabled when the -check-cfg
  /// option is specified on the command line and should enable checking
  /// bijection between LLVM and Target Machine CFG
  extern bool CheckCFG;

  /// AnnotationArch - Select architecture to annotate with -annotate
  /// option specified on the command line
  extern std::string AnnotationArch;
