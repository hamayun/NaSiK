...
MachineBasicBlock *BranchFolder::SplitMBBAt(MachineBasicBlock &CurMBB,
  ...
  BasicBlock *BB = (BasicBlock*)CurMBB.getBasicBlock();
  NewBBName = BB->getName() + "_split";
  BasicBlock *NewBB = BB->splitBasicBlock(--(BB->getInstList().end()), (const std::string) NewBBName);

  // Create the fall-through block.
  MachineFunction::iterator MBBI = &CurMBB;
  MachineBasicBlock *NewMBB =MF.CreateMachineBasicBlock(NewBB);
