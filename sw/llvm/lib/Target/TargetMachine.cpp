...
/*
static cl::opt<bool, true>
CheckCFGOpt("check-cfg",
		cl::desc("Check LLVM and Target Machine CFG bijection after each pass."),
		cl::location(CheckCFG), cl::init(false));
*/
static cl::opt<std::string,true>
AnnotationArchOpt("annotate",
  cl::desc("Architecture Name for Annotation (arm, mips, sparc ... )."),
  cl::location(AnnotationArch),
  cl::init(""));
