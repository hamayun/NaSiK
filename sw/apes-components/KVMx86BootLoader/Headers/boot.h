/*
 *  Copied and modified from linux (arch/x86/boot/boot.h)
 */
...
#define CAN_USE_HEAP 0x80               /* If set, the loader also has set */
...
void realm_putchar(int);
int realm_getchar(void);
void realm_kbd_flush(void);
int realm_getchar_timeout(void);
