...
int sc_main(int argc, char *argv[])
{
    ...
    soclib_blockdevice          blockdevice_0("blockdevice_0", 0, "input_large.ppm", 1);
    soclib_blockdevice          blockdevice_1("blockdevice_1", 1, "output_large_encode.jpg", 1);
    hosttime                    hosttime_0("hosttime", "cjpeg_host_time.txt"); 
