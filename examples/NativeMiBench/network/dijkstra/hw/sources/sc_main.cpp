...
int sc_main(int argc, char *argv[])
{
    ...
    soclib_blockdevice          blockdevice_0("blockdevice_0", 0, "input.dat", 1);
    soclib_blockdevice          blockdevice_1("blockdevice_1", 1, "output.dat", 1);
    hosttime                    hosttime_0("hosttime", "dijkstra_host_time.txt"); 
