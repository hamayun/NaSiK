...
export APES_CC2_FLAGS="-annotate=arm -soft-float -O3"
# "-march=arm --print-dual-cfg --print-annotated-cfg

#export APES_COMPILER="llvm-gcc"
#export APES_CC_FLAGS="-Wall -Wno-format -std=c99 -U__linux__ -fnested-functions -nostdinc $CUSTOM_INCLUDES"
...
# Old Secondary Compiler. Now we use LLVM but with-out annotations in case the Compilation Fails with Annotation.
