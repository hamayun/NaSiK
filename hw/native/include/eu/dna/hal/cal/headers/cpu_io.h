...
extern void __dnaos_hal_write_uint64(uint64_t *addr, uint64_t value);
extern void __dnaos_hal_write_sfloat(float *addr, float value);
extern void __dnaos_hal_write_dfloat(double *addr, double value);
...
extern uint64_t __dnaos_hal_read_uint64(uint64_t *addr);
extern float __dnaos_hal_read_sfloat(float *addr);
extern double __dnaos_hal_read_dfloat(double *addr);
