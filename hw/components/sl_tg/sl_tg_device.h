...
#ifndef _SL_TG_DEVICE_H_
#define _SL_TG_DEVICE_H_

#include <slave_device.h>

class sl_tg_device : public slave_device
{
public:
    sl_tg_device (const char *_name, const char *filename);
    virtual ~sl_tg_device ();
